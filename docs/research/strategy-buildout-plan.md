...
| 1.7 | `feat/event-net-of-cost-audit` | **NEW TOP PRIORITY (from report 17)**: re-run reports 04-16 deducting one full round-trip spread at real IDEALPRO spreads — does the live event edge survive? | pending |
