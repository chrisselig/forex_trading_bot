...
6. Schedule weekly currency momentum rebalance (every Monday, 8:22 AM MT / 14:22 UTC — after carry)
7. Run health checks every 5 minutes (auto-reconnects on disconnect)
8. Refresh the calendar every 6 hours
9. Shut down gracefully on `Ctrl+C`
...
```
   ...
   │  Straddle Strat  │ │ Surprise     │ │  Carry/Momentum │
   └──────────┬───────┘ └───┬──────────┘ └─┬──────────────┘
              │              │              │
              └──────────────┼──────────────┘
                             │ Signal
...
│   ├── strategy/              # BaseStrategy, straddle, surprise, carry, momentum
...
- [Trading Strategies](https://chrisselig.github.io/forex_trading_bot/trading/strategies/) — Straddle, surprise, carry, and currency momentum strategy details
